...
class ConnectWindow(CTk):
    def __init__(self):
        ...
        CTkLabel(self, text="Agario Game", text_color="#00ebff",font = ("Comic Sans MS", 40, "bold")).pack(pady=15, padx = 20,anchor="w")

        self.name_entry = CTkEntry(self, placeholder_text="Введіть ім'я:", height=50)
        self.name_entry.pack(padx = 20, anchor = "w", fill="x")

        self.host_entry = CTkEntry(self, placeholder_text="Введіть IP:", height=50)
        ...
        CTkButton(self, text = "Приєднатись до гри", height=50).pack(padx = 20, pady = 20,fill = "x")
